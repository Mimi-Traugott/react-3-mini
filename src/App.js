...
class App extends Component {
  ...
  getVehicles() {
    ...
    axios
      ...
      .then(response => {
        ...
        toast.success("Succesful Request");
      })
  ...
  sellCar(id) {
    ...
    .catch(() => toast.error("wow that is a terrible job"))
  }
  ...
  updatePrice(priceChange, id) {
    ...
    axios
      ...
      .then(response => {
        this.setState({
          vehiclestToDisplay: response.data.vehicles
        });
        toast.success(`Successful Request, you're a genius`);
      })
      .catch(() => toast.error(`Request Failed`));
  }
  ...
  addCar() {
    ...
    axios
      ...
      .then(response => {
        ...
        toast.success("Success Lady");
      })
      .catch(() => toast.error(`ya failed`));
  }
